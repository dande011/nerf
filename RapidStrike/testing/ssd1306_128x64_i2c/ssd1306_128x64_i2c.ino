...
void setup()   {                
  ...
  display.begin(SSD1306_SWITCHCAPVCC, 0x3C);  // initialize with the I2C addr 0x3D (for the 128x64) 0x3C 0x55
  // init done
  ...
  */
  ...
  //(x displacement, y displacement, *bitmap, width, height, color(1))
  display.println("Rapidstrike CS-18");
  //drawBitmap(0,0,108,64,rapidstrike);
  display.display();
  delay(2000);
  */
